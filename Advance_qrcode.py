...
label2 = Label(Frame2, text="Enter the location to save the QR Code: ", bg="DarkTurquoise", fg='azure',
               font=('FiraMono', 13, 'bold'))
...
label3 = Label(Frame3, text="Enter the name of the QR Code: ", bg="DarkTurquoise", fg='azure',
               font=('FiraMono', 13, 'bold'))
...
label4 = Label(Frame4, text="Enter the size from 1 to 40 with 1 being 21x21: ", bg="DarkTurquoise", fg='azure',
               font=('FiraMono', 13, 'bold'))
